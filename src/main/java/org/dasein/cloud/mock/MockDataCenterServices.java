 ...
 * <p>
 * Created by George Reese: 8/23/12 7:26 PM
 * </p>
 * 
 * @author George Reese
 * @version 2012.07
...
public class MockDataCenterServices implements DataCenterServices {
	...
	public MockDataCenterServices(CloudProvider cloud) {
		if (regions == null) {
	...
	@Override
	public @Nonnull Collection<DataCenter> listDataCenters(@Nonnull String providerRegionId) throws InternalException,
			CloudException {
