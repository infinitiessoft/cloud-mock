...
/**
 * Implements mocked up image management services for the Dasein Cloud mock
 * cloud.
 * <p>
 * Created by George Reese: 10/18/12 12:45 PM
 * </p>
 * 
 * @author George Reese
...
public class MockImageSupport implements MachineImageSupport {
	...
	static private final Map<String, Map<String, Collection<MachineImage>>> customImages =
			new HashMap<String, Map<String, Collection<MachineImage>>>();
	static private final Map<String, Map<String, Collection<MachineImage>>> publicImages =
			new HashMap<String, Map<String, Collection<MachineImage>>>();
	...
	@Override
	public void addImageShare(@Nonnull String providerImageId, @Nonnull String accountNumber) throws CloudException,
			InternalException {
	...
	@Override
	public @Nonnull String bundleVirtualMachine(@Nonnull String virtualMachineId, @Nonnull MachineImageFormat format,
	...
	@SuppressWarnings("deprecation")
	private @Nonnull MachineImage image(@Nonnull ProviderContext ctx, @Nonnull ImageCreateOptions options,
			@Nullable AsynchronousTask<MachineImage> optionalTask) throws CloudException, InternalException {
		VirtualMachine vm =
				provider.getComputeServices().getVirtualMachineSupport().getVirtualMachine(options.getVirtualMachineId());
		...
		try {
			Thread.sleep(15000L + (random.nextInt(45) * 1000L));
	...
	@SuppressWarnings("deprecation")
	@Override
	public @Nonnull AsynchronousTask<String> imageVirtualMachine(String vmId, String name, String description)
			throws CloudException, InternalException {
	...
	@Override
	public @Nonnull Iterable<ResourceStatus> listImageStatus(@Nonnull ImageClass cls) throws CloudException,
			InternalException {
	...
	@Override
	public @Nonnull Iterable<MachineImage> listImages(@Nonnull ImageClass cls, @Nonnull String ownedBy)
			throws CloudException, InternalException {
		ProviderContext ctx = provider.getContext();
	...
	@Override
	public @Nonnull Iterable<MachineImage> listMachineImagesOwnedBy(String accountId) throws CloudException,
			InternalException {
		ProviderContext ctx = provider.getContext();
	...
	@Override
	public @Nonnull MachineImage registerImageBundle(@Nonnull ImageCreateOptions options) throws CloudException,
			InternalException {
	...
	@Override
	public void removeImageShare(@Nonnull String providerImageId, @Nonnull String accountNumber) throws CloudException,
			InternalException {
	...
	private boolean matches(MachineImage img, @Nullable String accountNumber, @Nullable String keyword,
	...
	@Override
	public @Nonnull Iterable<MachineImage> searchMachineImages(@Nullable String keyword, @Nullable Platform platform,
			@Nullable Architecture architecture) throws CloudException, InternalException {
	...
	@Override
	public @Nonnull Iterable<MachineImage> searchImages(@Nullable String accountNumber, @Nullable String keyword,
	...
	@Override
	public @Nonnull Iterable<MachineImage> searchPublicImages(@Nullable String keyword, @Nullable Platform platform,
			@Nullable Architecture architecture, @Nullable ImageClass... imageClasses) throws CloudException,
			InternalException {
		ProviderContext ctx = provider.getContext();
	...
	@Override
	public String copyImage(ImageCopyOptions options) throws CloudException, InternalException {
	...
	public Iterable<MachineImage> listImages(ImageFilterOptions options) throws CloudException, InternalException {
		...
		images.addAll(getCustomImages(ctx));
		images.addAll(getPublicImages(ctx));
		// String keyword = options.getRegex();
		...
		// }
		// ImageClass[] classes =
		// Iterables.toArray(this.listSupportedImageClasses(),
		// ImageClass.class);
		return images;
	}

	@Override
	public Iterable<MachineImage> searchPublicImages(ImageFilterOptions options) throws InternalException, CloudException {
		String keyword = options.getRegex();
		Architecture architecture = options.getArchitecture();
		ImageClass cls = options.getImageClass();
		Platform platform = options.getPlatform();
		return searchPublicImages(keyword, platform, architecture, cls);
	}
	...
	@Override
	public void setTags(String imageId, Tag... tags) throws CloudException, InternalException {
		// NO-OP
	}

	@Override
	public void setTags(String[] imageIds, Tag... tags) throws CloudException, InternalException {
		// NO-OP
	}
}
