 ...
 * <p>
 * Created by George Reese: 10/17/12 6:04 PM
 * </p>
 * 
 * @author George Reese
 * @version 2012.09
 * @since 2012.09
 */
public class MockComputeServices extends AbstractComputeServices<CloudProvider> {

	private CloudProvider provider;


	public MockComputeServices(CloudProvider provider) {
		super(provider);
